...
<div class="flex-none w-0 relative h-2/3" role="presentation">
    <div onmousedown={keydown} onmouseup={keyup} onmouseleave={keyup} ontouchstart={keydown} ontouchend={keyup}
        ...
        class="absolute left-1/2 transform -translate-x-1/2 md:w-10 w-4 h-full rounded-md bg-gray-500 z-1 text-center border border-gray-900 cursor-pointer text-gray-200" role="presentation">
        {name}
    </div>
</div>
